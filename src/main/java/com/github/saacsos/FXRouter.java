...
public final class FXRouter {
    ...
    private static com.github.saacsos.FXRouter router;
    ...
    private static void checkInstances(Object ref, Stage win) {
        ...
        if (router == null) {
            router = new com.github.saacsos.FXRouter();
        }
    ...
    private static class RouteScene {
        ...
        private static String getWindowTitle() {
            return com.github.saacsos.FXRouter.windowTitle != null ? com.github.saacsos.FXRouter.windowTitle : "";
        }

        private static double getWindowWidth() {
            return windowWidth != null ? windowWidth : WINDOW_WIDTH;
        }

        private static double getWindowHeight() {
            return windowHeight != null ? windowHeight : WINDOW_HEIGHT;
        }
    }
}
